    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="px-2 md:px-3 py-2 hover:bg-red-500/20 rounded-lg transition-all text-red-300 hover:text-red-200 border border-red-500/30 hover:border-red-500/50 flex items-center gap-1 md:gap-2 text-xs md:text-sm font-medium whitespace-nowrap"
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button className="bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white shadow-lg hover:shadow-cyan-500/40 font-semibold py-5 md:py-6 text-xs md:text-base whitespace-nowrap">
