...
| 2 | `L1TokenFactory.createToken()`, fee \~0.01 ETH → **L1 address** | Ethereum |
| 3 | `L2SuperChainTokenFactory.createTokenWithBridge()` — **free**, links to L1 address | Celo |
