...
import { TokenCreated as TokenCreatedEvent } from "../generated/L2SuperChainTokenFactory/L2SuperChainTokenFactory"
import { TokenFactory, Token, TokenCreatedEvent as TokenCreatedEventEntity } from "../generated/schema"
import { L2SuperChainToken as L2SuperChainTokenTemplate } from "../generated/templates"
...
export function handleL2TokenCreated(event: TokenCreatedEvent): void {
  ...
  // Create dynamic data source to track token events (RemoteTokenUpdated, BridgeUpdated)
  L2SuperChainTokenTemplate.create(tokenAddress)
